<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1.Master" AutoEventWireup="true" CodeBehind="students.aspx.cs" Inherits="Sasip5.pages.students" %>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="card">
                                                        <div class="card-header card-header-primary">
                                                            <h4 id="header_add" runat="server" class="card-title">Add Student Profile</h4>
                                                            <h4 id="header_update" runat="server" class="card-title">Update Student Profile</h4>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ValidationGroup="Vali_save" runat="server" id="RequiredFieldValidator1" controltovalidate="txt_address" CssClass="badge badge-danger" errormessage="Please enter your Address..!" /> 
                                                                    </div>
                                                                </div>

                                                                   <div class="col-md-6 col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="bmd-label-floating" style="margin-left: 10px">Age</label>
                                                                        <asp:TextBox type="text" runat="server" ID="txt_age" class="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ValidationGroup="Vali_save" runat="server" id="RequiredFieldValidator4" controltovalidate="txt_age" CssClass="badge badge-danger" errormessage="Please enter your Age..!" /> 
                                                                    </div>
                                                                </div>
                                      ...
                                      <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator5" ValidationGroup="Vali_save" controltovalidate="drop_branch" CssClass="badge badge-danger" InitialValue="Select Branch" errormessage="Please Select Your Branch..!" /> 
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-9 col-sm-9">
                                                                    <asp:LinkButton class="btn btn-primary pull-right" runat="server" ID="btn_re_new" ValidationGroup="Vali_save" Text="Register" OnClick="btn_re_new_Click">

                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton class="btn btn-primary pull-right" runat="server" ValidationGroup="Vali_save" ID="btn_update" Text="Update"  OnClick="btn_update_Click"></asp:LinkButton>
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <asp:GridView ID="dgvItems" runat="server" CssClass="table table-hover table-striped table-responsive" GridLines="None" AutoGenerateColumns="False" AutoGenerateSelectButton="True" OnClientClick="return false;" Width="1050px" OnSelectedIndexChanged="dgvItems_SelectedIndexChanged">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="U_name" HeaderText="User_name" />
