<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1.Master" AutoEventWireup="true" CodeBehind="All_payments.aspx.cs" Inherits="Sasip5.pages.All_payments" %>
                    ...
                    <form method="get" runat="server">
                        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                     ...
                                     <div class="row">
                                        ...
                                        <asp:Button ID="btn_Employee" runat="server" Text="View Employee Payments" OnClick="btn_Employee_Click" class="btn btn-success" />
                                             </div>
                                    </div>
                        <!-- Data table -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <asp:DropDownList formControlName="type" runat="server" ID="drop_branch" class="browser-default custom-select">
                                             ...
                                             <asp:Button ID="btn_drop_search" runat="server" Text="Search" class="btn btn-success" OnClick="btn_drop_search_Click"/>
                                        </div>
