...
namespace Sasip5.pages.reports {
    ...
    public class E_payment : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Sasip5.pages.reports.E_payment.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedE_payment : Component, ICachedReport {
        
        public CachedE_payment() {
        }
